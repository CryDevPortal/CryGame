...
-------------------------------------------------------------------------
History:
- 31:05:2010  Created by Jens Schoebel
...
namespace Stereo3D
{
  ...
  {
    if ( !g_pGameCVars->g_stereoFrameworkEnable )
    {
      s_cvScreenDist = NULL;
      return;
    }
    ...
    //TODO: before getting this to work implement the newest version of raycast with distance
  ...
  namespace Weapon
  {
    ...
    void CWeaponCheck::OnRayCastResult(const QueuedRayID &rayID, const RayCastResult &result)
    {
      ...
      {
        // TODO: dist in newer version -> integrate newer version
