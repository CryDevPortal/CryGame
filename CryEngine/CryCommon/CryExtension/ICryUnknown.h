...
#define _BEFRIEND_CRYIIDOF()\
	...
	namespace Internal
	{
		template <class Dst, class Src> struct cryinterface_cast_boost_helper;
...
#define _BEFRIEND_CRYCOMPOSITE_QUERY()\
	template <class Src> friend boost::shared_ptr<ICryUnknown> CompositeQuerySemantics::crycomposite_query(const boost::shared_ptr<Src>&, const char*, bool*);\
	template <class Src> friend boost::shared_ptr<const ICryUnknown> CompositeQuerySemantics::crycomposite_query(const boost::shared_ptr<const Src>&, const char*, bool*);
