...
UNIQUE_IFACE struct ITacticalPointLanguageExtender
{
	...
	// Generate points
	virtual bool GeneratePoints(TGenerateParameters &parameters, SGenerateDetails &details, TObjectType pObject, 
		const Vec3& vObjectPos, TObjectType pObjectAux, const Vec3& vObjectAuxPos) const { return false; }
