...
private:
	...
	bool						m_hasBeenStarted;	// Indicates if the current test (or sequence) has been started.
...
/*
class CFlowNode_ListenForCommunication : public CFlowBaseNode, public ICommunicationManager::ICommGlobalListener
{
public:
...
class CFlowNode_SimulateInput : public CFlowBaseNode<eNCT_Instanced>
{
	enum EInputPorts
	{
		eInputPorts_Action,
